                ...
                <div class="content">
                  <div class="cont-grid">
                    <div class="recommend">
                      <center>
                        <br>
                      <h2 class="cat">Edit recipe</h2><br></center>
                    </div>
                 
                 <?php 

                 $sql = "SELECT * FROM recipe WHERE recipe_id = '".$_GET['recipeid']."' ";
                 ...
                 ?>
                  ...
                  <form name="form1" class="recipe-form" method="post" action="saveEditRecipe.php" enctype="multipart/form-data" >
                    <br>
                    <table class="tbl1">
                      <tr>
                        <td><h3>Title</h3></td>
                          ...
                          <div class="container">
                            <div class="wrapper">
                              <div id="display-img" class="image2">
                                <img src="<?php echo "".$row['recipe_img'].""; ?>" id="myImg" width="100" height="100" alt="">
                              </div>
                              ...
                              <input  name="image" type="hidden" value="<?php echo $row['recipe_img']; ?>">
                              <input id="uimage" name="uimage" type="file" accept="image/png, image/jpg">
                          </div>
                      ...
                      <tr>
                        <td>
                          <input  type="hidden" name="recid" value="<?php echo "".$row['recipe_id'].""; ?>">
                          <input class="rec-title" type="text" name="rec-title" value="<?php echo "".$row['recipe_name'].""; ?>" required><br><br><br></td>
                      <tr>
                      <tr>
                        <td><h3>Description</h3></td>
                      <tr>
                      <tr>
                        <td><input class="rec-title" type="text" name="rec-des" value="<?php echo "".$row['recipe_description'].""; ?>" required><br><br><br></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <div class="wrapper-slider">
                          <div class="slider">
                            <input type="range" name="rec-time" min="1" max="200" value="<?php echo "".$row['recipe_time'].""; ?>" id="myRange" class="sliderr" required>
                          </div>
                  ...
                  <?php
                                ...
                                ?> 
                                     <label class="option_item">
                                      ...
                                      <div class="option_inner">
                                        ...
                                        <div class="rec-cat"><?php echo "".$row2['catname'].""; ?></div>
                                      </div>
                    ...
                    <center>
                      <table class="tbl2">
                        ...
                        $ingr = preg_replace("<<br />>","\n\r", $row['recipe_ingredient']);
                        $steps = preg_replace("<<br />>","\n\r", $row['recipe_step']);

                        ?>
                        <tr>
                          <td><textarea class="rec-mats" id="ingr" name="rec-mats"  required><?php echo $ingr ?></textarea></td>
                          <td><textarea class="rec-step" id="steps" name="rec-step"  required><?php echo $steps ?></textarea></td>
                        </tr>
                      </table>
                    </center>
                    ...
                    <button type="submit" name="submit" class="create-btn">Update</button>
                    <br><br><br>
                  </form>
